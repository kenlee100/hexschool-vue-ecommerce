<template>
  <div class="flex flex-col mb-[60px]">
    <div class="overflow-hidden relative img-overlay">
      <img
        src="https://images.pexels.com/photos/2341830/pexels-photo-2341830.jpeg?auto=compress&cs=tinysrgb&w=1920&h=400&dpr=2"
