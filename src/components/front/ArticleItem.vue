<template>
  <div class="mb-20">
    ...
    <div
      class="relative z-10 -mt-8 lg:-mt-[84px] ml-4 lg:ml-[110px] py-6 px-[32px] bg-netural-netural-100"
    >
      <div class="[&:not(:last-child)]:mb-5">
        <h3 class="flex items-start [&:not(:last-child)]:mb-2">
          <p class="font-bold ch-body lg:ch-heading-4 text-secondary-secondary-100 line-clamp-2">
            東京行程規劃 帶你看日本 東京五天四夜花費
          </p>
        </h3>
        <div>
          <p class="font-normal ch-caption-2 lg:ch-body text-netural-netural-300 line-clamp-5">
      ...
      <div class="flex items-start">
        ...
        <div class="flex flex-col">
          <p class="ch-caption-2 lg:ch-caption-1 font-bold text-netural-netural-400">
            行程規劃小編
          </p>
          <p class="ch-caption-2 lg:ch-caption-1 font-normal text-netural-netural-300">
            12,Dec 2023
          </p>
        </div>
      </div>
